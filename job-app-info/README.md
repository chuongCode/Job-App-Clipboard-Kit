...
For everyday changes, click **Edit** in the popup, update the fields, and click **Save**. Use **Add +** in the Experience section to add another position. The saved profile is kept locally by `browser.storage.local`.
